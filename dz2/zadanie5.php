...
// Не принято
// 1) Строка 23455432 не является палиндромом? - без изменений работает, строка является палиндромом
// 2) Слишком много return; в рамках такой маленькой и простой функции
// 3) Проверить работу на строке "ААА" - на этой строке работает без изменений
    function one($string) {
